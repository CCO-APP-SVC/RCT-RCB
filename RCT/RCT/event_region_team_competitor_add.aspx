...
<table border="0" cellpadding="0" cellspacing="0" class="TXTNormal">
    <tr>
        ...
        <!-- =============================================== -->
        <!-- ===== FORMULAIRE D'AJOUT D'UN COMPÉTITEUR ===== -->
        <% 
        ...
        %>
            ...
            <form name="frmEventRegionTeamCompetitorAdd" id="frmEventRegionTeamCompetitorAdd" method="post" action="functions.aspx?fn=EventRegionTeamCompetitorAdd">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="10" align="center" valign="middle" bgcolor="#c0c0c0"></td>
                    <td class="LineVertico1PX"></td>
                    <td width="673" align="left" valign="middle" bgcolor="#c0c0c0">&nbsp;<b>Ajout d'un compétiteur pour : <% Response.Write(sqlDtSet.Tables("Region").Rows(0)("regionNameFr"))%> &nbsp; <% Response.Write(sqlDtSet.Tables("Team").Rows(0)("teamTypeNameFr"))%> &nbsp; <% Response.Write(sqlDtSet.Tables("Team").Rows(0)("teamNameFr"))%></b></td>
                    <td class="LineVertico1PX"></td>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="LineVertico1PX" height="30"></td>
                    <td align="center" valign="middle"><input type="text" name="txtTeamCompetitorLastName" id="txtTeamCompetitorLastName" autocomplete="off" style="width : 559px;" class="FormTextBox" /></td>
                    <td class="LineVertico1PX"></td>
                    <td align="center" valign="middle"><input type="text" name="txtTeamCompetitorBirthDate" id="txtTeamCompetitorBirthDate" datepicker="true" class="FormTextBox" style="text-align: center"/></td>
                    <td class="LineVertico1PX"></td>
            </table>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                ...
                <tr>
                    <td class="LineVertico1PX" height="30"></td>
                    <td align="center" valign="middle"><input type="text" name="txtTeamCompetitorFirstName" id="txtTeamCompetitorFirstName" autocomplete="off" style="width : 559px;" class="FormTextBox" /></td>
                    <td class="LineVertico1PX"></td>
                    <td align="center" valign="middle">
                        <select name="sGenderId" id="sGenderId" style="width: 190px" class="FormTextBox">
                            ...
                            <option value="<% Response.Write(sqlDtSet.Tables("Genders").Rows(i)("genderId")) %>"><% Response.Write(sqlDtSet.Tables("Genders").Rows(i)("genderNameFr"))%></option>
                            <% Next %>
                        </select>
                    </td>
                    <td class="LineVertico1PX"></td>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="LineVertico1PX" height="30"></td>
                    <td align="center" valign="middle"><input type="text" name="txtTeamCompetitorSerial" id="txtTeamCompetitorSerial" autocomplete="off" maxlength="3" style="width : 190px;" class="FormTextBox" /></td>
                    <td class="LineVertico1PX"></td>
                    <td align="center" valign="middle"><input type="text" name="txtTeamCompetitorUnit" id="txtTeamCompetitorUnit" autocomplete="off" style="width : 190px;" class="FormTextBox" /></td>
                    <td class="LineVertico1PX"></td>
                    <td align="left" valign="middle">&nbsp;
                        <select name="sCompetitorCategoryId" id="sCompetitorCategoryId" style="width: 160px" class="FormTextBox">
                            <% For i = 0 To sqlDtSet.Tables("Genders").Rows.Count - 1%>
                            <option value="<% Response.Write(sqlDtSet.Tables("CompetitorsCategories").Rows(i)("competitorCategoryId")) %>"><% Response.Write(sqlDtSet.Tables("CompetitorsCategories").Rows(i)("competitorCategoryNameFr")) %></option>
                            <% Next %>
                        </select>
                    </td>
                    <td class="LineVertico1PX"></td>
